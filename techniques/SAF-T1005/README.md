...
<!-- TODO: The Preventive Controls below describe endpoint-exposure-specific defenses
     ...
     debug-mode disable) that are not covered by any existing SAF-M mitigation as of
     this writing. Corpus-side follow-up: author SAF-M entries for these controls and
     replace the prose bullets here with `[SAF-M-X: Name](../../mitigations/SAF-M-X/README.md)`
...
### Detective Controls
1. **Process Monitoring**: Monitor for unusual child processes spawned by MCP servers, particularly shell commands, file operations, or network utilities. See [SAF-M-11: Behavioral Monitoring](../../mitigations/SAF-M-11/README.md).

2. **Network Monitoring**: Implement network traffic analysis to detect unauthorized access attempts, WebSocket port scanning, and suspicious enumeration patterns. See [SAF-M-11: Behavioral Monitoring](../../mitigations/SAF-M-11/README.md).

3. **HTTP Request Analysis**: Log and analyze all requests to MCP endpoints, flagging enumeration attempts, command injection patterns, and access from unexpected sources. See [SAF-M-12: Audit Logging](../../mitigations/SAF-M-12/README.md).

4. **Audit Network Bindings**: Regularly audit running MCP services to ensure they are not inadvertently bound to public interfaces. See [SAF-M-12: Audit Logging](../../mitigations/SAF-M-12/README.md).
...
## Related Techniques
- [SAF-T1109](../SAF-T1109/README.md): Debugging Tool Exploitation - Shares exploitation of 0.0.0.0 binding and CSRF vectors
- [SAF-T1601](../SAF-T1601/README.md): MCP Server Enumeration - Often follows initial endpoint access
- [SAF-T1602](../SAF-T1602/README.md): Tool Enumeration - Primary reconnaissance activity after gaining access
- [SAF-T1001](../SAF-T1001/README.md): Tool Poisoning Attack - Can be combined with exposed endpoint access
- [SAF-T1101](../SAF-T1101/README.md): Command Injection - Common exploitation technique after endpoint access
- [SAF-T1910](../SAF-T1910/README.md): Covert Channel Exfiltration - Data exfiltration following compromise
